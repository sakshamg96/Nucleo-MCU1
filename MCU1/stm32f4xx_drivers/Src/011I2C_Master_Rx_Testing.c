...
int main() {
	...
	while(1) {
		...
		I2C_MasterSendData(&I2C1Master, &cmd_code_len, 1, DEV_ADDR, ENABLE);

		I2C_MasterReceiveData(&I2C1Master, &msg_len, 1, DEV_ADDR, ENABLE);

		I2C_MasterSendData(&I2C1Master, &cmd_code_data, 1, DEV_ADDR, ENABLE);

		I2C_MasterReceiveData(&I2C1Master, (uint8_t*)recv_msg, msg_len, DEV_ADDR, DISABLE);
